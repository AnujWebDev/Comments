...
const Post4 = () => {
  const [posts, setPosts] = useState([
    {
      id: 1,
      title: 'Post 4-Click To See My Comments [300-400]',
      image:
  ...
  useEffect(() => {
    fetch('https://jsonplaceholder.typicode.com/comments?_start=300&_end=400')
    ...
    return (
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 md:w-1/2 sm:w-full p-4 border">
            <div>
              <h2 className="text-lg text-white font-semibold my-4">Comments for Selected Post 4</h2>
              {showComments && (
