...
const Post5 = () => {
  const [posts, setPosts] = useState([
    {
      id: 1,
      title: 'Post 5-Click To See My Comments [400-500]',
      image:
  ...
  useEffect(() => {
    fetch('https://jsonplaceholder.typicode.com/comments?_start=400&_end=500')
    ...
    return (
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 md:w-1/2 sm:w-full p-4 border">
            <div>
              <h2 className="text-lg text-white font-semibold my-4">Comments for Selected Post 5</h2>
              {showComments && (
