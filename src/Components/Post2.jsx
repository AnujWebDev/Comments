...
const Post2 = () => {
  const [posts, setPosts] = useState([
    {
      id: 1,
      title: 'Post 2-Click To See My Comments [100-200]',
      image:
  ...
  const [showComments, setShowComments] = useState(false); // Add state to control comment visibility

  useEffect(() => {
    fetch('https://jsonplaceholder.typicode.com/comments?_start=100&_end=200')
    ...
    return (
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:w-1/2 md:w-1/2 sm:w-full p-4 border">
            <div>
              <h2 className="text-lg text-white font-semibold my-4">Comments for Selected Post 2</h2>
              {showComments && (
