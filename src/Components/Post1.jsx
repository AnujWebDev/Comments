...
const Post1 = () => {
  const [posts, setPosts] = useState([
    {
      id: 1,
      title: 'Post 1-Click To See My Comments [0-100]',
      image:
  ...
  return (
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 md:w-1/2 sm:w-full p-4 border">
        <div>
          <h2 className="text-lg text-white font-semibold my-4">Comments for Selected Post 1</h2>
          {showComments && (
            ...
            <div className="comment-section text-white overflow-y-auto max-h-[400px]">
              <ul>
                {filteredComments.length === 0 ? (
                  <li className="mb-2 hover:bg-blue-600 hover:text-white border p-5">Not Found</li>
                ) : (
